...
class one_arg_1literal:
    ...
    @staticmethod
    def check(args):
        return len(args) == 1 and type(args[0]) != int
...
class one_arg_1local:
    ...
    @staticmethod
    def check(args):
        return len(args) == 1 and type(args[0]) != Local
...
class one_arg_1const:
    ...
    @staticmethod
    def check(args):
        return len(args) == 1 and type(args[0]) != Const_Type
...
class one_arg_2branch:
    ...
    @staticmethod
    def check(args):
        return len(args) == 1 and type(args[0]) != Op
...
class two_arg_1local_1literal:
    ...
    @staticmethod
    def check(args):
        return len(args) == 2 and type(args[0]) != Local and type(
            args[1]) == int
...
class two_arg_2const_1literal:
    ...
    @staticmethod
    def check(args):
        return len(args) == 2 and type(args[0]) != Const_Type and type(
            args[1]) == int
...
class lookupswitch:
    ...
    @staticmethod
    def check(args):
        return len(args) == 2 and type(args[0]) != Op and type(args[1]) == list
...
class tableswitch:
    ...
    @staticmethod
    def check(args):
        return len(args) == 4 and type(args[0]) != Op and type(
            args[1]) == int and type(args[2]) == int and type(args[3]) == list
...
for op_type in (zero_arg, one_arg_1literal, one_arg_2literal, one_arg_1local,
    ...
    for op_code, mnemonic in zip(op_type.op_codes,op_type.mnemonics):
        ...
        op_code_lookup[mnemonic] = op_code
